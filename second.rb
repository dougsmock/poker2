...
rank_w = 0
rank_w = white_report(a, b, c, d, e, f, g, h)
p rank_w


# handrank_b = black_report(b_high, b_pair, b_2pair, b_3s, b_straight, b_flush, b_full, b_4s, b_sf)
# p handrank_b

# w_sf = white_straights_flushes(wnumbs, wsuits)
# if w_sf != nil
#     handrank_w = 2 
#     p handrank_w
#     p w_sf
...
# w_flush = white_straights_flushes(wnumbs, wsuits)
# if handrank_w != 2
#     handrank_w = 5
#     p handrank_w
#     p w_flush
...
# w_straight = white_straights_flushes(wnumbs, wsuits)
# if handrank_w!= 2 && handrank_w != 5
#     handrank_w = 6
#     p handrank_w
#     p w_straight
# end
...
# if w_4 != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 3
#     p handrank_w
#     p w_4
# end
...
# if w_full != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 4
#     p handrank_w
#     p w_full
# end
...
# if w_3 != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 7
#     p handrank_w
#     p w_3
# end
...
# if w_2p != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 8
#     p handrank_w
#     p w_2p
# end
...
# if w_2 != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 9
#     p handrank_w
#     p w_2
# end
...
# if w_high != nil && handrank_w!= 2 && handrank_w != 5 && handrank_w != 6
#     handrank_w = 10
#     p handrank_w
#     p w_high
# end
